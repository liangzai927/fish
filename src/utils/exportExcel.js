 ...
 * @param worksheet
 */
export const setColumnWidth = function (columnWidth, worksheet) {
 ...
 * @param excelType
 */
export const setRowHeight = function (rowHeight, worksheet, excelType) {
 ...
 * @param worksheet
 */
export const setMerge = function (luckyMerge = {}, worksheet) {
 ...
 * @param worksheet
 */
export const setBorder = function (luckyBorderInfo, worksheet) {
 ...
 * @param worksheet
 */
export const setStyleAndValue = function (cellArr, worksheet) {
 ...
 * @param workbook
 */
export const setImages = function (images, worksheet, workbook) {
  ...
  for (let key in images) {
    ...
    //位置
    const tl = {
      col: images[key].default.left / 72,
      row: images[key].default.top / 19,
    };
    // 大小
    const ext = {
 ...
 * @param worksheet
 */
export const setFrozen = function (frozen = {}, worksheet) {
  switch (frozen.type) {
    // 冻结首行
    case "row": {
 ...
 * @param worksheet
 */
export const setRowHidden = function (rowhidden = {}, worksheet) {
 ...
 * @param worksheet
 */
export const setColHidden = function (colhidden = {}, worksheet) {
 ...
 * @param worksheet
 */
export const setFilter = function (filter = {}, worksheet) {
...
export const fillConvert = function (bg) {
  if (!bg) {
    return {};
  }
  ...
  let fill = {
    ...
    fgColor: {
      argb: bg.startsWith("#")
        ? bg.replace("#", "")
        : colorRGBtoHex(bg).replace("#", ""),
    },
  };
  return fill;
};

export const fontConvert = function (
  ff = 0,
  fc = "#000000",
  bl = 0,
  it = 0,
...
export const alignmentConvert = function (
  vt = "default",
  ht = "default",
  tb = "default",
  tr = "default",
...
export const borderConvert = function (borderType, style = 1, color = "#000") {
...
export function addborderToCell(borders, row_index, col_index) {
  let border = {};
  const luckyExcel = {
    type: {
      l: "left",
